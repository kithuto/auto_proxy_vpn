```{include} ../README.md
:end-before: <!-- hide-nav-contributing -->
```

```{include} ../README.md
:start-after: <!-- /hide-nav-contributing -->
:end-before: Each provider has its own README
```
...
```{include} ../README.md
:start-after: See each provider README for details.
:end-before: <!-- hide-contributing -->
```
